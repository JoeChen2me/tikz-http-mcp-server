#!/bin/bash
echo "🚀 正在部署TikZ HTTP MCP服务器（最小化镜像）..."
...
if [ ! -f "docker-compose.minimal.yml" ]; then
    echo "❌ 找不到docker-compose.minimal.yml文件"
    exit 1
fi

# 构建并启动服务
# 设置默认值
DEFAULT_SERVICE_NAME="tikz-mcp-server-minimal"
DEFAULT_CONTAINER_NAME="tikz-mcp-server-minimal-container"
DEFAULT_SERVICE_PORT="3001" # 与完整版区分
...
PORT="${PORT:-${DEFAULT_SERVICE_PORT}}"
...
echo "🏗️  正在构建和启动容器..."
docker-compose -f docker-compose.minimal.yml up -d ${BUILD_FLAG}
...
echo "}"
echo ""
echo "🔧 常用命令 (使用 docker-compose -f docker-compose.minimal.yml):"
...
echo "  停止服务: docker-compose -f docker-compose.minimal.yml stop"
echo "  删除服务容器: docker-compose -f docker-compose.minimal.yml down"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
